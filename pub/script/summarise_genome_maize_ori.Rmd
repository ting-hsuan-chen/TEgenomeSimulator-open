---
title: "A summary of the TE landscape of the original maize genome"
...
genomename <- 'maize_original'
short_gname <- 'maize'
setwd('../../')
WRK <- getwd()
SIM <- file.path(WRK, "pub/output/TEgenomeSimulator_maize_result/")
...
rmtbl <- paste0(SIM, "repeatmasker/GCF_902167145.1_Zm-B73-REFERENCE-NAM-5.0_genomic.fna.tbl")
```
