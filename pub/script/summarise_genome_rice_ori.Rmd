---
title: "A summary of the TE landscape of the original rice genome"
...
genomename <- 'rice_original'
short_gname <- 'rice'
setwd('../../')
WRK <- getwd()
SIM <- file.path(WRK, "pub/output/TEgenomeSimulator_rice_result/")
...
rmtbl <- paste0(SIM, "repeatmasker/GCF_034140825.1_ASM3414082v1_genomic.fna.tbl")
```
