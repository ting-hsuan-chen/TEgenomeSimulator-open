...
def print_genome_data(genome_dict, new_repeats_coord_dict, params):
...
def main():
    ##For custom genome with multiple chromosomes (user-provided non-TE genome)
    #Load chr parameters
    params_chr = parse_custom_genome_yaml('config_custom_genome_DH_5_100.yml')
    ...
    print_genome_data(genome, new_repeats_coord, params_chr)
