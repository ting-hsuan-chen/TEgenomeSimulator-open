...
- **{$prefix}_repeat_sequence_out_final.fasta**: The final simulated TE sequences, including the nested TEs, that have been inserted into the genome (from **Step 2**).
...
- The first release of TEgenomeSimulator v0.1.0 was built with the joint efforts from the Bioinformatics Analysis Team and Bioinformatics Engineering Team at Plant & Food Research. We appreciate all the advices and comments from our team members.
